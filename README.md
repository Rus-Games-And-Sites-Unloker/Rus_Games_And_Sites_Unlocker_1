...
Все старые Bat файлы немного скорректированы, но это позволило добавить "НАСТРОИТЬ список доменов.exe", для быстрого редактирования списка сайтов.

Его я взял отсюда: https://github.com/therealsdy/DiscordFix.
...
6. Затем запустить нужный вам файл.
