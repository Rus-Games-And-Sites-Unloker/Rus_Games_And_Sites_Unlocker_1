...
set LIST_TITLE=ZAPRET: Discord Fix Beeline-Rostelekom-InfolinkV2 
...
--filter-udp=50000-65535 --ipset="%IPSET_PATH%" --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=d3 --dpi-desync-repeats=6 ^
