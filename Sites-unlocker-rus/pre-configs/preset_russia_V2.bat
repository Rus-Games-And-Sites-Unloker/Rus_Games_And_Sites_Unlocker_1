...
set LIST_TITLE=ZAPRET: preset_russia (http,https,quic)V2 
...
--filter-udp=50000-50099 --ipset="%IPSET_PATH%" --dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-any-protocol --dpi-desync-cutoff=n4 --new ^
